...
class NumberOfReferencingModules(Metric):
    ...
    def visitModule(self, node, *args):
        node.NumberOfReferencingModules = len(set(module for (call, function, class_, module) in node.referencedby if module and (module != node)))
    def visitClass(self, node, *args):
        node.NumberOfReferencingModules = len(set(module for (call, function, class_, module) in node.referencedby if module and (module != node.module)))
