...
class MaintainabilityIndex(Metric):
    """Maintainability index of a (Project, Module, Function)
    """
    requires = ('MaintainabilityIndexWithoutComments', 'MaintainabilityIndexCommentWeight')
    def countMaintainabilityIndex(self, node, *args):
        node.MaintainabilityIndex = node.MaintainabilityIndexWithoutComments + node.MaintainabilityIndexCommentWeight
    visitFunction = countMaintainabilityIndex
    def visitProject(self, node, *args):
        self.countMaintainabilityIndex(node, *args)
