...
class VariablesCounter(Visitor):
    result = 0
...
class NumberOfVariables(Metric):
    """Number of variables used in a (Module)
    
    Count the number of variables declared inside the body of a module
    """
    def visitModule(self, node, *args):
        node.NumberOfVariables = compiler.walk(node, VariablesCounter()).result