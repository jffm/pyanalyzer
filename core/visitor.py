...
class Visitor(object):
    """This class implements a Visitor pattern. It has to be used with compiler.walk
    usage: result = compiler.walk(ast, Visitor()).result
    """
    # requires = ()
    log = None # should be set by the initialisation of pyanalyzer
    def default(self, node, *args):
        for child in node.getChildNodes():
            self.visit(child, *args) # visit will be stored by compiler.walk
